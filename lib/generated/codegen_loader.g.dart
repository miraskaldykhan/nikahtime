...
class CodegenLoader extends AssetLoader{
  ...
  "usersScreen": {
    ...
    "searchNotFound": "К сожалению, мы не нашли пользователей по Вашему запросу",
    "searchHint": "Введите строку для поиска",
    "searchMainHint": "Для поиска пользователей необходимо в строке поиска ввести имя или фамилию",
    "notFound": "К сожалению, тут пока еще никого нет",
    "match": {
      "male": "{firstName} тоже вами интересуется!\nВы можете написать первым.",
      "female": "{firstName} тоже вами интересуется!\nВы можете написать первой.",
  ...
  "profileScreen": {
    ...
    "settings": {
      ...
      "donate_msg": {
        ...
        "text": "Дорогой пользователь, если ты сделаешь Садака (пожертвование), то эти средства пойдут на то, чтобы сделать этот мир добрее! А также на развитие и поддержку проекта NikahTime!",
  ...
  "paymentScreen": {
    ...
    "error": {
      "title": "Ошибка",
      "closeButton": "Закрыть",
      "unknown": "К сожалению, покупка недоступна по неизвестной причине. Пожалуйста, попробуйте позже.",
      "clientInvalid": "Покупка не может быть совершена, попробуйте сменить аккаунт или устройство.",
      "paymentCancelled": "Вы отменили покупку.",
      "paymentInvalid": "Покупка отклонена. Пожалуйста, проверьте платёжные данные и убедитесь, что на счету достаточно средств.",
      "paymentNotAllowed": "Покупка недоступна для выбранного платёжного метода. Пожалуйста, убедитесь, что Ваш платёжный метод позволяет оплачивать покупки в интернете.",
      "storeProductNotAvailable": "Данный продукт недоступен в вашем регионе. Пожалуйста, смените магазин и повторите попытку.",
      "cloudServicePermissionDenied": "Покупка отклонена.",
      "cloudServiceNetworkConnectionFailed": "Покупка не может быть совершена, потому что устройство оффлайн. Пожалуйста, попробуйте ещё раз при стабильном подключении к интернету.",
      "cloudServiceRevoked": "Покупка отклонена.",
      "privacyAcknowledgementRequired": "Покупка не может быть совершена, поскольку вы не согласились с условиями использования AppStore. Пожалуйста, подтвердите согласие в настройках и вернитесь к покупке.",
      "unauthorizedRequestData": "Возникла ошибка. Пожалуйста, вернитесь к покупке позже.",
      "invalidOfferIdentifier": "Промо-предложение недействительно.",
      "invalidSignature": "Извините, возникла ошибка при использовании промо-кода. Пожалуйста, попробуйте позже.",
      "missingOfferParams": "Извините, возникла ошибка при использовании промо-предложения. Пожалуйста, попробуйте позже.",
      "invalidOfferPrice": "Извините, покупка невозможна. Попробуйте повторить её позже.",
      "verifyError": "Извините, возникла ошибка покупки. Средства будут возвращены через 3 дня, если подписка не активируется.",
      "verifyAppStoreError": "Извините, возникла ошибка покупки. Средства будут возвращены через 3 дня, если подписка не активируется.",
      "duplicateProductObject": "Активация подписки в обработке. Средства будут возвращены через 3 дня, если подписка не активируется."
    }
  },
  "tariffs": {
    "description": "Одни из основных целей приложения NikahTime - это ускорить процесс поиска второй половики, поженить и выдать замуж максимальное количество желающих людей",
    "header": "Функционал премиум подписки:",
    "option1": "Отображение количества просмотров историй одним и тем же человеком",
    "option2": "Отображение времени просмотра сторис",
    "option3": "Анонимный просмотр сторис",
    "option4": "Возможность анонимного чтение смс",
    "option5": "Возможность просмотра времени последнего посещения пользователей",
  ...
  "common": {
    ...
    "payment": {
      "alert": {
        ...
        "detail": "Только сейчас подписка по цене чашки кофе☕️\nНе упусти возможность найти свою вторую половинку!",
  ...
  "claim": {
    ...
    "description": "Мы рассмотрим жалобу в течение 24 часов и, если будет обнаружено нарушение, примем необходимые меры для его пресечения.",
    "send": "Отправить",
  ...
  "welcome_screen": {
    ...
    "carousel": {
      "item1": {
        ...
        "text": "Настраивайте фильтры и находите только\nтех, кто Вам нравится"
      },
      "item2": {
        "header": "Только люди",
        "text": "Наше приложение проводит тщательную\nпроверку, не пропуская ни одного бота"
      },
      "item3": {
        "header": "Общайтесь",
  ...
  "registration": {
    ...
    "type": {
      ...
      "phone": {
        ...
        "header": "Мой номер",
        "text": "Пожалуйста, введите ваш актуальный номер телефона. Мы отправим вам 6-значный код для подтверждения вашей учетной записи.",
        "hintPass": "Придумайте пароль",
        "hintSecPass": "Повторите пароль",
        "error": "Пользователь с таким номером телефона уже существует. Если это Вы - пройдите процедуру восстановления пароля",
        "nextScreenMessage": "указанный номер телефона"
      },
      "email": {
        "by": "По адресу E-mail",
        "header": "Мой E-mail",
        "text": "Пожалуйста, введите ваш действующий Email адрес. Мы отправим вам 6-значный код для подтверждения вашей учетной записи.",
        "hintMail": "Введите Email",
        "hintPass": "Придумайте пароль",
        "hintSecPass": "Повторите пароль",
        "error": "Пользователь с таким Email-адресом уже существует. Если это Вы - пройдите процедуру восстановления пароля",
    ...
    "interest": {
      ...
      "subheader": "Добавьте минимум 5 интересов, чтобы мы могли подобрать более подходящих людей",
      "addNew": "Добавить свой"
    },
    "about": {
      "header": "О себе",
      "subheader": "Напиши немного информации о себе. Так тебе будут писать больше людей.",
      "example": "Например: У меня высшее образование, по утрам гуляю с собакой, в свободное время хожу в кино."
    }
  },
  "entering": {
    "error": {
      "dataType": "Проверьте правильность введенных данных и повторите попытку\nПример номера: +79998887766 или 79998887766\nПример email-адреса: address@mailbox.domain",
      "nouser": "Запрашиваемого пользователя не существует или пароль введен неверно. Проверьте правильность введенных данных и повторите запрос.",
      "badEmail": "Введен некорректный email-адрес. Проверьте правильность ввода и повторите запрос.\nПример корректного mail-адреса: xxx@xxx.xx",
      "badNumber": "Введен некорректный номер. Проверьте правильность ввода и повторите запрос.\n"
    },
    "main": {
      "header": "Вход",
    ...
    "recoveryBy": {
      "email": {
        ...
        "msg": "Введите свой Email и вам на почту придет письмо с кодом для восстановления пароля"
      },
      "number": {
        "hint": "Введите номер телефона",
        "get": "Получить код",
        "header": "Восстановление пароля",
        "msg": "Введите свой номер телефона и вам придет СМС с кодом для восстановления пароля"
      },
      "error": "Что-то пошло не так. Пожалуйста, повторите попытку позднее"
    },
    "conclusion": {
      "header": "Пароль успешно восстановлен",
      "msg": "Теперь вы можете использовать новый пароль для защиты своих данных",
      "ok": "Понятно"
    },
    "create": {
      "header": "Восстановление пароля",
    ...
    "code": {
      ...
      "error": "Не удалось отправить код проверки. Пожалуйста, проверьте правильность введенных данных и повторите попытку",
      "error_uncorrect": "Введен некорректный код. Пожалуйста, проверьте правильность введенных данных и повторите попытку",
      "action": "Восстановить",
      "header": "Восстановление пароля",
      "message": "Код отправлен на {}:\n {}"
    },
...
static const Map<String,dynamic> en = {
  ...
  "profileScreen": {
    ...
    "settings": {
      ...
      "donate_msg_text": "Assalamu Alaikum wa Rahmatullahi wa Barakatuh and greetings of the day, dear user! The goal of the NikahTime app is that, by the grace of Allah, everyone who wishes can find happiness and their other half! You have the opportunity to participate in this noble cause and help NikahTime improve by making a Sadaqah (donation) to the card number 2202 2032 5291 7218. We are raising these funds to develop and release a new version of NikahTime!",
      "text_copied": "Card number copied",
      "phone_copied": "Phone number copied",
      "donate_msg": {
        "header": "Support the Project",
        "text": "Dear user, if you make a Sadaqah (donation), these funds will go toward making the world a kinder place! It will also support the growth and maintenance of the NikahTime project!",
        "text2": "Thank you! You are helping us make the world a better place!",
        "later_btn": "Later",
        "support_btn": "Support"
      },
      "theme": {
  ...
  "tariffs": {
    "description": "One of the main goals of the NikahTime app is to speed up the process of finding a soulmate, helping as many people as possible to get married.",
    "header": "Premium Subscription Features:",
    "option1": "Display the number of times stories are viewed by the same person",
