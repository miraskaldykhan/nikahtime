...
class PeopleWhoVizitedMeScreen extends StatefulWidget{
  ...
  @override
  State<PeopleWhoVizitedMeScreen> createState() => PeopleWhoVizitedMeScreenState();
}
...
class PeopleWhoVizitedMeScreenState extends State<PeopleWhoVizitedMeScreen> {
  ...
  Widget waitBox(){
    return Column(
      ...
      children: [
        const CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 00, 207, 145)),),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLoadingComplete ? SizedBox (
