      ...
      children: [
       ...
       child: Container(
              ...
              (widget.item.images == null ||
                        ...
                        child: displayMedia(
                          context,
                          widget.item.images![0].main.toString(),
                          items: widget.item.images!.map((e) => e.main).toList().cast<String>(),
                          initPage: 0,
              ...
              top: 16,
              child: Visibility(
                visible: (widget.item.isProfileParametersMatched != null &&
                     ...
                     SizedBox(
                      width: 140,
                       child: Column(
                         ...
                         children: [
                           Text(
                             "${widget.item.firstName ?? ""}, ${ widget.item.age ?? 0}",
                             style: TextStyle(
                               fontWeight: FontWeight.w700,
                               fontSize: 22,
                               color: Colors.white,
                                                   ...
                                                   child: GestureDetector(
                                                     ...
                                                     child: Container(
                                                            ...
                                                            child: Icon(MenuIcons.favorite,
                                                                color: widget.item.inFavourite ? Theme.of(context).colorScheme.secondary : Colors.white, size: 20,),
                                                          ),
                                                   ),
                                  ),
                                    ],
