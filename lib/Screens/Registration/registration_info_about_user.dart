...
class RegistrationInfoAboutUserScreen extends StatefulWidget {
  RegistrationInfoAboutUserScreen(this.userProfileData, {Key? key}) : super(key: key);

  UserProfileData userProfileData;

  @override
  State<RegistrationInfoAboutUserScreen> createState() => _RegistrationInfoAboutUserScreenState();
}

class _RegistrationInfoAboutUserScreenState extends State<RegistrationInfoAboutUserScreen> {
  @override
            ...
            Expanded(
                child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
                          const _PhotoPlace(),
                          CustomInputDecoration().titleText(LocaleKeys.registration_about_header.tr()),
                          CustomInputDecoration().subtitleText(LocaleKeys.registration_about_subheader.tr()),
                          TextField(
...
class _RegisterButton extends StatefulWidget{
  ...
  Future<void> _putNewUserInfo() async {
    ...
    trackerParams.setAge(
        DateTime.now().difference(localize.DateFormat("dd-MM-yyyy").parse(userProfileData.birthDate!)).abs().inDays ~/ 365
    );
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed:(){
                          Navigator.push(
                            context,
                            PageRouteBuilder(
                              pageBuilder: (_, __, ___) => RegistrationSetupInterestUserSettingsScreen(widget.userProfileData),
