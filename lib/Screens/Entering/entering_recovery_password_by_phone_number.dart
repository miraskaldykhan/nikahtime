...
class EnteringRecoveryPasswordByPhoneNumberScreen extends StatefulWidget {
  ...
  @override
  State<EnteringRecoveryPasswordByPhoneNumberScreen> createState() =>
      _EnteringRecoveryPasswordByPhoneNumberScreenState();
}

class _EnteringRecoveryPasswordByPhoneNumberScreenState
    extends State<EnteringRecoveryPasswordByPhoneNumberScreen> {
  ...
  _sendLoginRequest() async {
    ...
    String number = _emailTextController.text
        .replaceAll("+", "")
        .replaceAll(" ", "")
        .replaceAll("-", "");
    ...
    var response = await NetworkService()
        .RestoreAccountPasswordCode("phoneNumber", number);
